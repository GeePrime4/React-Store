        ...
        <div>
            {womensClothes.length === 0 ? (
                ...
                <div className='row g-0 p-4'>
                    {womensClothes.map(({ id, title, image, price, rating, description, category }) => (
...
export default FetchWomensClothes ;
